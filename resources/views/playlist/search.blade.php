...
<div class="container">
  <div class="box__general">
    <h2 class="box__general--heading mt-3">Playlist hinzufügen</h2>
    <form method="GET" action="{{ route('searchResultsPlaylist', $currentPlanner) }}">
      @csrf
      <div class="search">
        <input name="q" type="text" class="searchTerm" placeholder="Suche...">
    ...
    <a class="btn-back" href="{{ route('planner.show', $currentPlanner) }}">
